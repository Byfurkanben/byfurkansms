...
while 1:
    ...
    Sms: {}           {}kurucu {}@byfurkanyldrm1 sadece izin verilen kişiler kullanabilir aksi takdirde ip adresinizden baldınız sikilecektir\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder (Normal-Hız)\n\n 2- SMS Gönder (SEX😈)\n\n 3- Çıkış\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
